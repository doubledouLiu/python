...
def login_cnblogs(username,password):
    ...
    try:
        ...
        cmm_lgn = driver.find_element_by_xpath(".//a[contains(@rseat,'cmm_lgn')]")
        cmm_lgn.click()
        time.sleep(5)

        input_username = driver.find_element_by_xpath("//*[@class='txt-info txt-account']")
        input_pwd = driver.find_element_by_xpath("//*[@class='txt-info txt-password']")
        signin = driver.find_element_by_xpath("//*[@class='btn-green btn-login btn-gray']")
...
if __name__ == '__main__':
    login_cnblogs(username='18320781961',password='doudou240703!!')
